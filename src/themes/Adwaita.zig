...
pub const light = Theme{
    ...
    .font_body = .{ .name = "Vera" },
    .font_heading = .{ .scale = 1.1, .name = "VeraBd" },
    .font_caption = .{ .scale = 0.8, .name = "Vera" },
    .font_caption_heading = .{ .scale = 1.2, .name = "VeraBd" },
    .font_title = .{ .scale = 1.5, .name = "Vera" },
    .font_title_1 = .{ .scale = 1.4, .name = "VeraBd" },
    .font_title_2 = .{ .scale = 1.3, .name = "VeraBd" },
    .font_title_3 = .{ .scale = 1.2, .name = "VeraBd" },
    .font_title_4 = .{ .scale = 1.1, .name = "VeraBd" },
