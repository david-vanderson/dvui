...
pub fn structUI() void {
    ...
    // The initial breakage is fixed, but it is now broken because.
    // Theme has Options, which have *WidgetData, which has Options, giving a circular reference from Options to Options.
