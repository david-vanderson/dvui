...
// Note : Import widgets this way (i.e. importing them in `src/widgets.zig`
...
pub const DropdownWidget = @import("widgets.zig").DropdownWidget;
...
pub const PlotWidget = @import("widgets.zig").PlotWidget;
...
pub const SuggestionWidget = @import("widgets.zig").SuggestionWidget;
pub const TabsWidget = @import("widgets.zig").TabsWidget;
