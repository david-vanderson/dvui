...
pub const QuickTheme = struct {
    ...
    pub fn toTheme(self: @This(), gpa: std.mem.Allocator) !Theme {
        ...
        return Theme{
            ...
            .style_accent = .{
                .color_accent = Color.alphaAverage(color_accent, color_accent),
                .color_text = Color.alphaAverage(color_accent, color_text),
                .color_text_press = Color.alphaAverage(color_accent, color_text_press),
                .color_fill = Color.alphaAverage(color_accent, color_fill),
                .color_fill_hover = Color.alphaAverage(color_accent, color_fill_hover),
                .color_fill_press = Color.alphaAverage(color_accent, color_fill_press),
                .color_border = Color.alphaAverage(color_accent, color_border),
            },
            .style_err = .{
                .color_accent = Color.alphaAverage(color_accent, color_accent),
                .color_text = Color.alphaAverage(color_err, color_text),
                .color_text_press = Color.alphaAverage(color_err, color_text_press),
                .color_fill = Color.alphaAverage(color_err, color_fill),
                .color_fill_hover = Color.alphaAverage(color_err, color_fill_hover),
                .color_fill_press = Color.alphaAverage(color_err, color_fill_press),
                .color_border = Color.alphaAverage(color_err, color_border),
            },
